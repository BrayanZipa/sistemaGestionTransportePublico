...
public class DataLoader {
    ...
    public static void cargarTodo(
        ...
        precargarBoletos(boletoManager, pasajeroManager, rutaManager);
    }
    ...
    private static void precargarBoletos(
    	...
    	BoletoVO b1 = new BoletoVO(1, LocalDateTime.now(), "A1",
